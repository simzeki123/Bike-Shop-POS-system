...
public class Daily_report_OLD extends Report_OLD {
    ...
    public void generate_report_ID(int choice) {
        ...
        switch (choice) {
            case 1:
                ...
                break;
            case 2:
                report_type_code = "DSTF";
                break;
            case 3:
                report_type_code = "DSC";
                break;
            case 4:
                report_type_code = "MC";
                break;
    ...
    public void print_basic_report() {
        ...
        for (int i = 0; i < payment_records.size(); i++) {
            System.out.printf("" + payment_records.get(i).getPayment_id() + "		"
                    + payment_records.get(i).getOrder_member().getMemberID() + "  	"
                    + payment_records.get(i).getOrder_staff().getId() + "		"
                    + payment_records.get(i).getDate() + "		"
                    + payment_records.get(i).getBike_ordered().getId() + "		"
                    + payment_records.get(i).getTotal_sales_of_transaction() + "		\n\n");
            contributionAmt += payment_records.get(i).getTotal_sales_of_transaction();
        }
        System.out.printf(
                "Total amount :																		%.2lf\n",
                contributionAmt);
    ...
    public void print_staff_repot() {
        ...
        for (int i = 0; i < payment_records.size(); i++) {
            System.out.printf("" + payment_records.get(i).getPayment_id() + ""
                    + payment_records.get(i).getOrder_staff().getId() + "" + ""
                    + payment_records.get(i).getOrder_staff().getName() + "" + payment_records.get(i).getDate()
                    + "" + payment_records.get(i).getTotal_sales_of_transaction() + "");
            contributionAmt += payment_records.get(i).getTotal_sales_of_transaction();
        }
        System.out.printf(
    ...
    public void print_stock_report() {
        ...
        for (i = 0; i < bikeList.getListOfBike().size(); i++) {
            System.out.print(
                    bikeList.getListOfBike().get(i).getId() + "			 " + bikeList.getListOfBike().get(i).getColor()
                            + "			" + bikeList.getListOfBike().get(i).getBrand() + "			"
                            + bikeList.getListOfBike().get(i).getPrice() + "			 "
                            + bikeList.getListOfBike().get(i).getAvailability() + "\n");
        }
    }
    ...
    public void print_member_report() {
        ...
        for (int i = 0; i < payment_records.size(); i++) {
            System.out.printf("" + payment_records.get(i).getPayment_id() + ""
                    + payment_records.get(i).getOrder_member().getMemberID() + ""
                    + payment_records.get(i).getOrder_member().getName() + ""
                    + payment_records.get(i).getBike_ordered().getId() + "" + payment_records.get(i).getDate()
                    + "" + payment_records.get(i).getPayment_used());
        }
    }
