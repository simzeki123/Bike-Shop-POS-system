...
public class Order implements Cloneable {
    ...
    public void order() {
        ...
        while (!salesperson.getId().equals(staffBase[0].getId()) && !salesperson.getId().equals(staffBase[1].getId())
                && !salesperson.getId().equals(staffBase[2].getId())
                && !salesperson.getId().equals(staffBase[3].getId())
                && !salesperson.getId().equals(staffBase[4].getId())
                && !salesperson.getId().equals(staffBase[5].getId())
                && !salesperson.getId().equals(staffBase[6].getId())
                && !salesperson.getId().equals(staffBase[7].getId())
                && !salesperson.getId().equals(staffBase[8].getId())
                && !salesperson.getId().equals(staffBase[9].getId())) {
        ...
        while (!salesperson.getName().toUpperCase().equals(staffBase[0].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[1].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[2].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[3].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[4].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[5].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[6].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[7].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[8].getName())
                && !salesperson.getName().toUpperCase().equals(staffBase[9].getName())) {
            System.out.print("Invalid input, please try again!!\n");
            System.out.print("Please enter your name: ");
            salesperson.setName(input.nextLine());
        }
        ...
        if (Character.toUpperCase(order.isMember) == 'Y') {
            ...
            while (!member.getMemberType().toUpperCase().equals("BASIC")
                    && !member.getMemberType().toUpperCase().equals("PREMIUM")) {
                System.out.print("Invalid input, please try again!!\n");
                System.out.print("[Basic, Premium]\n");
                System.out.print("Which member type are you: ");
                member.setMemberType(input.nextLine());
            ...
            while (!member.getMemberID().equals(memberBase[0].getMemberID())
                    && !member.getMemberID().equals(memberBase[1].getMemberID())
                    && !member.getMemberID().equals(memberBase[2].getMemberID())
                    && !member.getMemberID().equals(memberBase[3].getMemberID())
                    && !member.getMemberID().equals(memberBase[4].getMemberID())
                    && !member.getMemberID().equals(memberBase[5].getMemberID())
                    && !member.getMemberID().equals(memberBase[6].getMemberID())
                    && !member.getMemberID().equals(memberBase[7].getMemberID())
                    && !member.getMemberID().equals(memberBase[8].getMemberID())
                    && !member.getMemberID().equals(memberBase[9].getMemberID())) {
                System.out.print("Invalid input, please try again!!\n");
                System.out.print("Please enter your member ID: ");
                member.setMemberID(input.nextLine());
            }
            ...
            while (!member.getName().toUpperCase().equals(memberBase[0].getName())
                    && !member.getName().toUpperCase().equals(memberBase[1].getName())
                    && !member.getName().toUpperCase().equals(memberBase[2].getName())
                    && !member.getName().toUpperCase().equals(memberBase[3].getName())
                    && !member.getName().toUpperCase().equals(memberBase[4].getName())
                    && !member.getName().toUpperCase().equals(memberBase[5].getName())
                    && !member.getName().toUpperCase().equals(memberBase[6].getName())
                    && !member.getName().toUpperCase().equals(memberBase[7].getName())
                    && !member.getName().toUpperCase().equals(memberBase[8].getName())
                    && !member.getName().toUpperCase().equals(memberBase[9].getName())) {
                System.out.print("Invalid input, please try again!!\n");
                System.out.print("Please enter your name: ");
                member.setName(input.nextLine());
            }
            ...
            while (!member.getMemberIC().equals(memberBase[0].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[1].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[2].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[3].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[4].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[5].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[6].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[7].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[8].getMemberIC())
                    && !member.getMemberIC().equals(memberBase[9].getMemberIC())) {
                System.out.print("Invalid input, please try again!!\n");
                System.out.print("Please enter your IC Number: ");
                member.setMemberIC(input.nextLine());
            }
        ...
        if (Character.toUpperCase(order.getCfrm()) == 'Y') {
            ...
            if (Character.toUpperCase(order.isMember) == 'Y' && member.getMemberType().toUpperCase().equals("BASIC")) {
                ...
                System.out.printf("Bike Price   : %.2f\n", bikeBase[order.getSlct() - 1].getPrice()
                        - (bikeBase[order.getSlct() - 1].getPrice() * 10 / 100));
            ...
            if (Character.toUpperCase(order.isMember) == 'Y'
                ...
                System.out.printf("Bike Brand   : %s\n", bikeBase[order.getSlct() - 1].getBrand());
                System.out.printf("Bike Price   : %.2f\n", bikeBase[order.getSlct() - 1].getPrice()
                        - (bikeBase[order.getSlct() - 1].getPrice() * 15 / 100));
                System.out.printf("Availability : %s\n", bikeBase[order.getSlct() - 1].getAvailability());
            }
